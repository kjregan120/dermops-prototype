 ...
 *
 * Collections: customers, users (providers + support staff, distinguished by
 * `role`), appointments, skinSites, visitNotes, messageThreads, messages.
...
const DB = (() => {
  ...
  const STORAGE_KEY = 'dermaops.db.v1';
